...
{if $article->getAuthors()}
    <ol class="item authors">    
            <h5>               
        {foreach name=authors from=$article->getAuthors() item=author key=i}
            <li class="author">
                <span class="name">
...
<div class="col-lg-12" id="article-nav">
        <div id="nav-absolute-position">
            <nav class="article-menu nav nav-tabs" id="myTab" role="tablist">
                <a class="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab" href="#nav-summary" role="tab" aria-controls="nav-summary" aria-selected="true">
                        <i class="far fa-file fa-lg"></i>
                        <span class="tab-title">
                            {translate key="plugins.tocoTheme.journal.summary.display"}
                        </span>
                    </a>
             ...
             <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane active" id="nav-summary" role="tabpanel" aria-labelledby="nav-summary-tab">
                            {* Abstract *}
